...
|---|---|
| [matchzy-auto-tournament](https://github.com/Auto-Tournament/matchzy-auto-tournament) | The platform: web app, API and database, shipped as one Docker image. Being renamed to Auto Tournament. |
